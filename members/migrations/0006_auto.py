...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field match on 'Division'
        db.create_table('members_division_match', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('division', models.ForeignKey(orm['members.division'], null=False)),
            ('match', models.ForeignKey(orm['members.match'], null=False))
        ))
        db.create_unique('members_division_match', ['division_id', 'match_id'])

    def backwards(self, orm):
        # Removing M2M table for field match on 'Division'
        db.delete_table('members_division_match')
    ...
    models = {
        ...
        'members.division': {
            ...
            'match': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['members.Match']", 'null': 'True', 'blank': 'True'}),
