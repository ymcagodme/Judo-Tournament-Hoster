...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tournament.title'
        db.alter_column('members_tournament', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
    def backwards(self, orm):

        # Changing field 'Tournament.title'
        db.alter_column('members_tournament', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
    models = {
        'auth.group': {
